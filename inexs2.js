...
afDelta.innerHTML = "Votre inéquation est " + inequation +"<br> Pour commencer il faut maitre votre inéquation sous forme d'équation<br> On aura " + a + "x<sup>2</sup>" + " " + afb + "x " + afc+" = 0" + rep+ "<br><b class='jaune'>"+ ensesolu+"</b><br><br><b class='ble'>CALCUL ET EXPLICATION</b><br><br>Pour commencer nous devons chercher la valeur de Delta qui a comme formule<br> b<sup>2</sup> - (4 * a * c)<br> Donc avec notre équation on aura " + b + "<sup>2</sup> - ( 4 * "+ a + " * "+ c + ") = "+ Dela + " - (" + Delb + ") = " + Delta + "<br>Maintenant On doit analyser notre Delta il y a trois possibilités<br><br> 1. Si Delta est supérieur à 0 on aura X<sub>1</sub> et X<sub>2</sub> avec X<sub>1</sub> = ((-b) + la racine carrée de Delta)/(2 * a) et X<sub>2</sub> = ((-b) - la racine carrée de Delta)/(2 * a)<br>Pour l'étude de signe comme on a deux point 0(où l'équation est égal à 0) on devra aligner nos deux X du plus petit au plus grand puis vérifier le signe de a(+ ou -) on mettra le signe de a à gauche du plus petit x et à droit du plus grand puis au milieu de deux x on mettra le signe contraire de a<br>Dans l'intervalle qui aura le signe + le trinôme sera supérieur à 0 et L'intervalle avec le signe - le trinôme sera inférieur à 0 <br><br>2. Si Delta est égal à 0 on aura seulement une variable x car Delta étant égal à 0 X<sub>1</sub> sera égal X<sub>2</sub> car la différence entre leurs formules est que dans la première Delta est additionner mais dans la deuxième Delta est soutrait Donc si Delta est égal à 0 il n'y a plus de différence car additionner ou soustraire 0 rien ne va changer dans les deux cas<br>Pour l'étude de signe comme on a une variable x(Qui est notre point 0 ) à gauche de x et à droite de x on mettra le signe de a<br><br>3. Si Delta est inférieur à 0 alors l'équation sera dit impossible car<br><b class='jaune'>NB: il n'existe pas de racine réelle d'indice paire(2,6,4,8,10,...) d'un nombre négatif et comme dans notre cas c'est une racine carrée(indice 2) donc si Delta est inférieur à 0(il est négatif) l'équation sera dit impossible car pas de racine réelle<br>Pour l'étude de signe on mettra le signe de a partout dans l'ensemble R </b> "
afDelta.id = "ff"
...
if(a == 0)
{
    ...
    affimpo = imposible.innerHTML = "<b class='jaune grand bg-white'>Votre inéquation n'est pas du second degré mais plutôt du premier degré de forme "+b + "x "+ afc+" "+ signed+" 0 Car a = 0 <br>consultez le deuxième point du menu pour la resolution et l'explication de cette forme<b/>"
