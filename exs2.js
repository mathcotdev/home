...
if(a == 0)
{
    ...
    const imposible = document.createElement("div")
    affimpo = imposible.innerHTML = "<b class='jaune grand container border bg-white'>Votre équation n'est pas du second degré mais plutôt du premier degré de forme "+b + "x "+ afc+" = 0 Car a = 0 <br>consultez le premier point du menu pour la resolution et l'explication de cette forme<b/>"
...
if (Delta > 0) {
    ...
    let suit = document.createElement("p")
    suit.innerHTML = "<br><br>Dans notre cas vous l'avait deviner il s'agit de la deuxième possibilité car Deltat est égale à 0<br>Comme delta est égal à 0 on va cherche directement X comme il est explique ci-dessus<br>avec<br> X = -(b) / (2 * a) <br> = -("+ b +")/" + " (2 * "+ a +") = " + (-( b)) + " / "+ (2*a) + " = " + X1
    let aff = document.getElementById("resolutionexs2").innerHTML = afDelta.innerHTML + suit.innerHTML
}
